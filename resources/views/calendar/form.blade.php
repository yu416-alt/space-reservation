...
@section('content')
    ...
    @csrf
        ...
        <tr>
        <td><input type="radio" name="entry" value="guest" checked>  ゲストとして予約</td><td>
        <input type="radio" name="entry" value="member">  会員登録して予約</td>
        </tr>
        </table>
        <br>
        <div class="background-color">
        
        <p>以下の項目を入力し会員登録して頂くと、次回から入力の手間が省けるほか、予約情報の参照を行えます。</p><br>
        ...
        <tr>
        <th>性別</th>
        <td><input type="radio" name="sex" value="男性" checked>男性　　　<input type="radio" name="sex" value="女性">女性</td><br>
        </tr>
        <tr>
        <th>年齢</th>
        <td>
