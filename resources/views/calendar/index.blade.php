@extends('layouts.testapp')
    ...
    @section('login-button')
        ...
        <div>
            ...
            <a href="member/logout" class="login-btn logout display-none"><i class="fas fa-sign-out-alt"></i>ログアウト</a>
            <a href="member/logout" class="logout-icon"><i class="fas fa-sign-out-alt"></i></a>
            
        </div>
        @else
        <div>
            <a href="member" class="login-btn">会員ログイン</a>
        </div>
        @endif
    ...
    <div class="fast-view">
        ...
        <div class="band">
            <p class="fs-30px">○○駅徒歩<span>5</span>分</p>
            <p class="fs-24px">レンタルオフィス</p>
    ...
    <section>
        ...
        <div>
            ...
            <a href="calendar/schedule?room=roomA" class="button">空室状況確認・予約</a>
        </div>
    </section>
    <section>
        <h2>会議室B</h2>
    ...
    <section>
        ...
        <div>
            ...
            <br>
            <a href="calendar/schedule?room=roomC">空室状況確認・予約</a>
        </div>
    </section>
    </div>
    ...
    <h2>その他サービス</h2>
    <p>フロントにてコピー機を有料でご利用いただけます。<br>
    マイクや追加ホワイトボードのレンタルは無料で行っております。当日フロントにてお申し付けくださいませ。</p>
    <br>
    <br>
    
    <h2>ご利用について</h2>
        <p class="fs-15px">営業時間　　<span class="orange">８：００～２３：００</span></p><br>
        
    <p>・<span class="orange">最低３時間以上</span>のご予約でご利用いただけます。<br>・初回予約時に会員登録して頂きますと、次回以降の利用時に簡単予約が可能になります。</p>
    </div>
    
    <div class="padding">
    <h2>アクセス</h2>
    <div class="flex">
    <p class="fs-15px">○○駅 北改札口より徒歩５分<br><br>
    〒000-0000<br>
    大阪府大阪市○○町1-2-3<br><br>
    TEL<br>
    <span class="fs-15px">012-3456-7890</span></p>
